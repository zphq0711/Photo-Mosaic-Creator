...
class SQtree {
 ...
 private:
  ...
  /**
   * Return the number of nodes in the tree that curr is the root.
   * You may want a private helper for this.
   * @param curr The current root of a tree.
   * @return the number of nodes in the tree that curr is the root.
   */
  int size(const Node* curr);

  /**
   * Render returns a PNG image consisting of rectangles defined
   * by the leaves in the sqtree.  Draws every leaf node's rectangle
   * onto a PNG canvas using the average color stored in the node.
   * @param im The image need to render.
   * @param root The root of SQtree.
   */
   ...
   * current SQtree class.
   * You may want a recursive helper function for this one.
   * @param curr The current SQtree to be cleared.
   */
   ...
   * Does not free any memory. Called by copy constructor and op=.
   * You may want a recursive helper function for this one.
   * @param curr The current SQtree to be copied.
   * @return Node pointer.
   */
